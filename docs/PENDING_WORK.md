...
| PW-003 | pending | Prisma Assistant — Canal A | RCA-1–4 y RCA-5a–5c aceptados offline; RCA-5 sigue incompleto. Próxima sesión: conectar bot A → HMI vinculada → contexto vigente → respuesta al teléfono, con verificación acotada. Ampliación de arneses pausada; checkpoint WIP no equivale a aceptación integral. Ver `odd/tasks/prisma-channel-a-remote.md`. | `backlog/prisma-dual-channel-assistant` | 2026-09-17 |
