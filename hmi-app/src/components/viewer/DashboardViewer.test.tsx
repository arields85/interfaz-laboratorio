...
describe('DashboardViewer', () => {
    ...
    it('passes overview availability state to widget renderers', async () => {
        const dashboard = makeDashboard({
            widgets: [makeWidget({ id: 'widget-1', title: 'Origin' })],
            layout: [makeLayout({ widgetId: 'widget-1', x: 0, y: 0, w: 4, h: 3 })],
        });
    ...
    it('passes dashboard navigation callbacks to widget renderers', async () => {
        const onNavigateDashboard = vi.fn();
        const dashboard = makeDashboard({
            widgets: [makeWidget({ id: 'widget-1', title: 'Origin', type: 'text-title' } as never)],
            layout: [makeLayout({ widgetId: 'widget-1', x: 0, y: 0, w: 4, h: 3 })],
        });
