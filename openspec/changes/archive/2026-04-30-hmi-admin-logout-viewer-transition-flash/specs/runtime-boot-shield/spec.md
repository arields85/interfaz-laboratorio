...
(Previously: the same shield also reappeared during warm resume and focus recovery.)
...
(Previously: runtime font readiness was aligned in intent, but the requirement did not forbid hook-local hardcoded font-name gating.)
